 ...
 * @labelField name
 */
component dataManagerGroup="contact" {
	property name="name"  type="string" dbtype="varchar"  maxLength="50"  required="true";
	property name="email" type="string" dbtype="varchar"  maxLength="50"  required="true";
	property name="phone" type="string" dbtype="varchar"  maxLength="50"  required="true";
