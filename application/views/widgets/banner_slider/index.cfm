	...
	<section class="banner-custom">
		<div class="container-fulid banner-wraper">
			<div class="col-md-6 banner-video">
				<iframe width="650" height="400" src="https://www.youtube.com/embed/eoJecvGMR6E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
