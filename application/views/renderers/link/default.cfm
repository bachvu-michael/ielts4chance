<cfscript>
	...
	param name="args.before"    type="string"  default="";
	param name="args.after"    type="string"  default="";
	...
	if(!isEmpty(args.before)){
		args.body = args.before & args.body;
	}
	if(!isEmpty(args.after)){
		args.body &= args.after;
	}
</cfscript>
